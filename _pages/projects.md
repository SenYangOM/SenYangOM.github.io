...
The same architecture also runs on an independent self-funded crypto research project outside Cubist (joint work with Beier Liu), as a cross-market validation of the scaffolding. [Live performance is public](https://dash.300k.xyz/group/300kinvestorshowcaseaccounts?period=30d) — please set the time range to Jan 1, 2025 to view the full track.
